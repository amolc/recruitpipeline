...
urlpatterns = [
    ...
    path('adminpanel/edit-requests/', admin_views.super_edit_requests, name='super_edit_requests'),
    path('adminpanel/edit-requests/<int:pk>/', admin_views.super_edit_request_detail, name='super_edit_request_detail'),
    path('adminpanel/edit-requests/<int:pk>/approve/', admin_views.super_edit_request_approve, name='super_edit_request_approve'),
    path('adminpanel/edit-requests/<int:pk>/reject/', admin_views.super_edit_request_reject, name='super_edit_request_reject'),
